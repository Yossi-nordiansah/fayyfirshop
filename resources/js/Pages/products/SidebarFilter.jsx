...
/**
 * MobileFilterDrawer — Slide-in drawer filter for mobile screens.
            ...
            {mobileFiltersOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-0 top-0 bottom-0 w-80 bg-white z-[1000] p-6 flex flex-col space-y-6 lg:hidden shadow-2xl"
                    >
                        {/* Drawer Header */}
...
/**
 * SidebarFilter — Desktop sticky sidebar filter.
 */
