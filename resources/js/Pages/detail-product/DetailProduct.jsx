...
export default function DetailProduct({ product: initialProduct, slug }) {
    ...
    const handleWhatsAppInquiry = () => {
        ...
        let message = `Halo Fayyfir Shop, saya tertarik dengan produk ini:\n\n`;
        message += `*Nama Produk*: ${displayName}\n`;
        if (variantName) {
            message += `*Varian*: ${variantName}\n`;
        }
                        ...
                        >
                            ...
                            <div className="flex gap-3">
                                ...
                                >
                                    ...
                                    <span>{t("product.detail.whatsapp_btn", "Tanyakan produk via whatsapp")}</span>
                                </motion.button>
                            </div>
                            ...
                            <motion.button
                                ...
                                className="w-full mt-3 flex items-center justify-center gap-2.5 py-4 rounded-2xl bg-gradient-to-r from-blue-700 to-blue-600 hover:from-blue-800 hover:to-blue-700 text-white font-bold text-sm transition-all shadow-lg disabled:opacity-40 disabled:cursor-not-allowed text-nowrap"
                            >
                                <Check size={18} />
