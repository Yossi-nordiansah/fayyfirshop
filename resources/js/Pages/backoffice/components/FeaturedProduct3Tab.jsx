...
export default function FeaturedProduct3Tab({ featuredProduct3 = [] }) {
    ...
    const featuredItem = featuredProduct3 && featuredProduct3.length > 0 ? featuredProduct3[0] : null;
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (editingItem) {
            post(`/backoffice/content/featured-product-3/${editingItem.id}`, {
                onSuccess: () => {
    ...
    const handleToggleActive = (id) => {
        router.patch(`/backoffice/content/featured-product-3/${id}/toggle-active`, {}, {
            preserveScroll: true,
        });
    };
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-100">
                <div>
                    <h2 className="text-lg font-bold text-slate-800">
                        {t('backoffice.promo2.title', 'Promo Section 2 (Posisi Tengah - Di Bawah Produk Terbaru)')}
                    </h2>
                    <p className="text-xs text-slate-500">
                        {t('backoffice.promo2.subtitle', 'Kelola banner Promo Section 2 yang memisahkan bagian Produk Terbaru dan Produk Terlaris.')}
                    </p>
                </div>
            </div>
            ...
            {!featuredItem ? (
                <div className="bg-white p-8 rounded-xl border border-slate-200 text-center text-slate-400">
                    {t('backoffice.featured3.loading', 'Memuat data Featured Product 2...')}
                </div>
            ) : (
                <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-xs space-y-6">
                    <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-100">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                <span>{featuredItem.is_active ? t('backoffice.featured3.status_active', 'Tampil di Beranda (Aktif)') : t('backoffice.featured3.status_inactive', 'Sembunyikan dari Beranda (Non-Aktif)')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span>{t('backoffice.promo2.edit_btn', 'Edit Konten Promo Section 2')}</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-1">
                            <span className="block text-xs font-bold text-slate-500">{t('backoffice.featured3.bg_label', 'Gambar Background Section (Featured Product 2)')}</span>
                    ...
                    <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden my-8 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="bg-slate-900 text-white px-6 py-4 flex items-center justify-between">
                            <h3 className="font-bold text-base flex items-center gap-2">
                                ...
                                {t('backoffice.modal.edit_promo2_title', 'Edit Promo Section 2 (3 Bahasa & Pop-Up Icon)')}
                            </h3>
                            <button
                                type="button"
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[82vh] overflow-y-auto">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder={t('backoffice.featured.badge_id_placeholder', 'Contoh: Produk Terlaris Pilihan')}
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    ...
                                    <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 space-y-1.5">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <input
                                                type="color"
                                                value={data.button_color || '#10b981'}
                            ...
                            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                                ...
                                >
                                    {processing ? t('backoffice.common.saving', 'Menyimpan...') : t('backoffice.promo2.save_btn', 'Simpan Promo Section 2')}
                                </button>
                            </div>
                        </form>
                    </div>
