            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-100">
                <div>
                    <h2 className="text-lg font-bold text-slate-800">
                        {t('backoffice.featured.title', 'Featured Product Section (Single Banner)')}
                    </h2>
                    <p className="text-xs text-slate-500">
                        {t('backoffice.featured.subtitle', 'Kelola konten section Featured Product beranda, status aktif, gambar background, 3 bahasa, dan pop-up pemilih icon keunggulan.')}
                    </p>
                </div>
            </div>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-100">
                        <div className="flex items-center gap-3">
                            <span className="px-3 py-1 text-xs font-extrabold bg-amber-100 text-amber-900 border border-amber-300 rounded-full">
                                {featuredItem.badge_translations?.id || featuredItem.badge || 'Special Premium Product'}
                            </span>
                            <h3 className="text-base font-bold text-slate-900">
                                {featuredItem.title_translations?.id || featuredItem.title}
                            </h3>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                <span>{t('backoffice.featured.edit_btn', 'Edit Konten Featured Product')}</span>
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="space-y-2 lg:col-span-2">
                            ...
                            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3 text-xs">
                                ...
                                <div className="pt-2 border-t border-slate-200 flex items-center justify-between text-slate-600">
                                    <span className="font-bold">{t('backoffice.featured.target_link_label', 'Target Link Tombol ("Beli Sekarang"):')}</span>
                    ...
                    <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden my-8 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="bg-slate-900 text-white px-6 py-4 flex items-center justify-between">
                            <h3 className="font-bold text-base flex items-center gap-2">
                                ...
                                {t('backoffice.modal.edit_featured_title', 'Edit Featured Product (3 Bahasa & Pop-Up Icon)')}
                            </h3>
                            <button
                                type="button"
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[82vh] overflow-y-auto">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                <div>
                                                    <label className="block text-xs font-bold text-slate-700 mb-1">
                                                        {t('backoffice.featured.badge_id_label', 'Badge Atas (ID)')}
                                                    </label>
                                                    <input
                                                        type="text"
                                                        value={data.badge_id}
                                                ...
                                                <div>
                                                    <label className="block text-xs font-bold text-slate-700 mb-1">
                                                        {t('backoffice.featured.title_id_label', 'Judul Utama Produk (ID)')} <span className="text-rose-500">*</span>
                                                    </label>
                                                    <input
                                                        type="text"
                                                        required
                                                        ...
                                                        placeholder={t('backoffice.featured.title_id_placeholder', 'Contoh: Alsharif Pure Honey Marai')}
                            ...
                            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                                ...
                                >
                                    {processing ? t('backoffice.common.saving', 'Menyimpan...') : t('backoffice.featured.save_btn', 'Simpan Featured Product')}
                                </button>
                            </div>
                        </form>
                    </div>
