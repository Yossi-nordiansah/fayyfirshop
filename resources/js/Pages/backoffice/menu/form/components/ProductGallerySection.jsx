...
// ─── ImageUploadZone ──────────────────────────────────────────────────────────
function ImageUploadZone({ previews = [], primaryIndex = 0, onAdd, onRemove, onSetPrimary }) {
        ...
        <div className="space-y-3">
            ...
            >
                ...
                <div className="text-center">
                    ...
                    <p className="text-xs">JPG, PNG, WEBP — bisa pilih beberapa sekaligus</p>
                </div>
...
export default function ProductGallerySection({ previews, primaryIndex, onAdd, onRemove, onSetPrimary }) {
    return (
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-center gap-3 border-b border-slate-100 pb-3">
                <ImageIcon className="h-5 w-5 text-amber-500" />
                <h3 className="text-base font-bold text-blue-950">Galeri Produk</h3>
