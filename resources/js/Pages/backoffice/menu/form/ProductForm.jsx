...
export default function ProductForm({
        ...
        if (hasParentRelations) {
            ...
            return parents.map(p => {
                ...
                return {
                    ...
                    discount_price: hasSub ? '' : (p.discount_price ?? ''),
            ...
            variants: [
                {
                    ...
                    sku: '', price: '', discount_price: '', unit_id: '', weight: '',
    ...
    const submit = async (e) => {
        ...
        form.transform((data) => {
                ...
                if (v.has_sub_variants && v.sub_variants && v.sub_variants.length > 0) {
                    ...
                    const cleanedSubVariants = v.sub_variants.map((sv) => {
                        ...
                        return {
                            ...
                            sku: sv.sku ?? '',
                            price: sv.price ?? '',
                            discount_price: (sv.discount_price !== '' && sv.discount_price !== null && sv.discount_price !== undefined) ? sv.discount_price : '',
                    ...
                    transformedVariants.push({
                        ...
                        sku: v.sku ?? '',
                        price: v.price ?? '',
                        discount_price: (v.discount_price !== '' && v.discount_price !== null && v.discount_price !== undefined) ? v.discount_price : '',
                        unit_id: null,
                        image: v.image,
            ...
            return {
                ...data,
                discount_price: (data.discount_price !== '' && data.discount_price !== null && data.discount_price !== undefined) ? data.discount_price : '',
                weight: finalWeight,
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-blue-950 selection:text-white">
            <Head title={`${isEditing ? t('backoffice.product.form.page_title_edit', 'Edit Produk') : t('backoffice.product.form.page_title_create', 'Tambah Produk')} - Backoffice`} />
