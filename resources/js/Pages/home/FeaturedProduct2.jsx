...
export default function FeaturedProduct2({ featuredProduct2 = [] }) {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-blue-950/20">
            ...
            <div className="absolute inset-0 z-10 flex items-center">
                <div className="max-w-8xl mx-auto px-4 sm:px-8 md:px-14 py-4 sm:py-6 md:py-10 lg:py-16 w-full grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8 items-center">
                    ...
                    <motion.div
                        ...
                        className="flex flex-col space-y-2 sm:space-y-4 md:space-y-6 text-white max-w-xl md:ml-auto"
                    >
                        {/* Badge Atas (Opsional) */}
                        {badgeText && (
                            <motion.div
                                variants={itemVariants}
                                className="inline-flex items-center space-x-1.5 sm:space-x-2 bg-blue-500/20 border border-blue-400/40 backdrop-blur-md px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full w-fit"
                            >
                                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-300 shrink-0" />
                                <span className="text-[10px] sm:text-xs font-semibold tracking-wider uppercase text-blue-200">
                                    {badgeText}
                                </span>
                            </motion.div>
                        )}
                            ...
                            <div className="space-y-1 sm:space-y-2.5">
                                {titleText && (
                                    <motion.h2
                                        ...
                                        className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-cyan-300 to-blue-200 leading-tight md:leading-[1.15]"
                                    >
                                        {titleText}
                                    </motion.h2>
                                )}
                            ...
                            >
                                ...
                                {hasFeature1 && (
                                    <div className="flex items-start space-x-2 sm:space-x-3">
                                        <div className="p-1.5 sm:p-2 bg-blue-950/40 border border-blue-400/30 rounded-lg text-blue-300 backdrop-blur-sm shrink-0">
                            ...
                            <motion.div variants={itemVariants} className="pt-1 sm:pt-3">
                                {isFullExternal ? (
                                    <a
                                        ...
                                        className={`group relative inline-flex items-center justify-center px-5 py-2.5 sm:px-8 sm:py-3.5 font-medium tracking-wide transition-all duration-300 ease-in-out ${activeItem?.button_color ? '' : 'bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500'
