                        ...
                        <div className="space-y-3">
                            {titleText && (
                                <motion.h2
                                    ...
                                    className="md:leading-[60px] text-3xl md:text-5xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 via-teal-300 to-emerald-200"
                                >
                                    {titleText}
                                </motion.h2>
                            )}
                        ...
                        <motion.div variants={itemVariants} className="pt-4">
                            {isFullExternal ? (
                                <a
                                    ...
                                    className={`group relative inline-flex items-center justify-center px-8 py-3.5 font-medium tracking-wide transition-all duration-300 ease-in-out ${activeItem?.button_color ? '' : 'bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500'
