...
export default function FeaturedProduct3({ featuredProduct3 = [] }) {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-emerald-950/20">
                    ...
                    >
                        ...
                        {badgeText && (
                            <motion.div
                                ...
                                className="inline-flex items-center space-x-1.5 sm:space-x-2 bg-emerald-500/20 border border-emerald-400/40 backdrop-blur-md px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full w-fit"
                            >
                                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-300 shrink-0" />
                                <span className="text-[10px] sm:text-xs font-semibold tracking-wider uppercase text-emerald-200">
                                    {badgeText}
                                </span>
                            </motion.div>
                        )}
                            ...
                            <div className="space-y-1 sm:space-y-2.5">
                                {titleText && (
                                    <motion.h2
                                        ...
                                        className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 via-teal-300 to-emerald-200 leading-tight md:leading-[1.15]"
                                    >
                                        {titleText}
                                    </motion.h2>
                                )}
                            ...
                            >
                                ...
                                {hasFeature1 && (
                                    <div className="flex items-start space-x-2 sm:space-x-3">
                                        <div className="p-1.5 sm:p-2 bg-emerald-950/40 border border-emerald-400/30 rounded-lg text-emerald-300 backdrop-blur-sm shrink-0">
                            ...
                            <motion.div variants={itemVariants} className="pt-1 sm:pt-3">
                                {isFullExternal ? (
                                    <a
                                        ...
                                        className={`group relative inline-flex items-center justify-center px-5 py-2.5 sm:px-8 sm:py-3.5 font-medium tracking-wide transition-all duration-300 ease-in-out ${activeItem?.button_color ? '' : 'bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500'
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-xs sm:text-sm md:text-base">{btnText}</span>
                                    </a>
                                ) : (
                                    <Link
                                        href={targetUrl}
