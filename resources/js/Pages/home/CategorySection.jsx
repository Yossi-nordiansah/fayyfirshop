                             ...
                             <div className="absolute inset-0 flex flex-col items-center justify-end p-10 text-center">
                                 <motion.div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                     ...
                                     <Link
                                         ...
                                         className="px-8 py-3 bg-white/10 backdrop-blur-md border border-white/30 text-white text-[10px] font-['Cinzel'] font-bold uppercase tracking-[0.2em] hover:bg-blue-500 transition-all duration-300 rounded-sm inline-block"
                                     >
