...
const getCourierLogo = (courierName) => {
    ...
    if (name.includes("jne")) return "/images/couriers/jne.webp";
    if (name.includes("j&t") || name.includes("jnt") || name.includes("j-t") || name.includes("j and t")) return "/images/couriers/jnt.webp";
    if (name.includes("sicepat") || name.includes("si cepat")) return "/images/couriers/sicepat.webp";
    if (name.includes("pos")) return "/images/couriers/pos.webp";
    if (name.includes("anteraja") || name.includes("anter aja")) return "/images/couriers/anteraja.webp";
    if (name.includes("tiki")) return "/images/couriers/tiki.webp";
    if (name.includes("ninja")) return "/images/couriers/ninja.webp";
    if (name.includes("gojek") || name.includes("gosend")) return "/images/couriers/gojek.webp";
    if (name.includes("grab")) return "/images/couriers/grab.webp";
    if (name.includes("lion")) return "/images/couriers/lion.webp";
    if (name.includes("idexpress") || name.includes("id express")) return "/images/couriers/idexpress.webp";
    if (name.includes("paxel")) return "/images/couriers/paxel.webp";
    if (name.includes("lalamove")) return "/images/couriers/lalamove.webp";
    if (name.includes("wahana")) return "/images/couriers/wahana.webp";
    return null;
};
